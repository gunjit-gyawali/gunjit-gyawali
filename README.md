...
- 💻 1+ year experience building real projects  
- 🛠️ Completed 5+ projects  
- 🤝 200+ Student Mentored
- 📧 gunjitgyawali1@gmail.com
...
I specialize in:
- 🌐 **Web Development** — Websites, web apps, UX/UI  
- 🎮 **Game Development** — Interactive games & fun experiences  
...
| 🌟 Languages / Tools | ⚙️ Interests |
|----------------------|---------------|
| JavaScript | Anime & F1 Racing |
| HTML & CSS | Robotics |
| Game Engines | Tech Learning |
| Git & GitHub | Designing Interfaces |
